 document.getElementById("searchBtn").addEventListener("click", (event) => {
  ...
  fetch(apiUrl)
    ...
    .then(function (data) {
      ...
      var cdescription = data.weather[0].description;
       ...
       <div class="col s10 m5">
        <div class="card blue-grey darken-1">
          <div class="card-content white-text">
           ...
           <span class="card-title">${cDay}/${cMonth}/${cYear}</span>
           <span class="card-title"> Described as:  ${cdescription}</span>
...
document.getElementById("searchBtn").addEventListener("click", (event) => {
    ...
    fetch(apiUrl5Days)
      ...
      .then(function (data1) {
        ...
        var temp1 = data1.list[1].main.temp;
        var wind1 = data1.list[1].wind.speed;
        var humidity1 = data1.list[1].main.humidity;
        var date1 =data1.list[1].dt
           

        var temp2 = data1.list[2].main.temp;
        var wind2 = data1.list[2].wind.speed;
        var humidity2 = data1.list[2].main.humidity;
        var date2 =data1.list[2].dt

        var temp3 = data1.list[3].main.temp;
        var wind3 = data1.list[3].wind.speed;
        var humidity3 = data1.list[3].main.humidity;
        var date3 =data1.list[3].dt

        var temp4 = data1.list[4].main.temp;
        var wind4 = data1.list[4].wind.speed;
        var humidity4 = data1.list[4].main.humidity;
        var date4 =data1.list[4].dt
      ...
      <div class="row">
        <div class="col s4 m2">
          <div class="card blue-grey darken-1">
           <div class="card-content white-text">
            <span class="card-title"> Date: ${date1}</span>
            <ul class="result"  >
      ...
      <div class="col s4 m2">
        <div class="card blue-grey darken-1">
         <div class="card-content white-text">
          <span class="card-title"> Date: ${date2}</span>
          <ul class="result"  >
    ...
    <div class="col s4 m2">
      <div class="card blue-grey darken-1">
       <div class="card-content white-text">
        <span class="card-title"> Date: ${date3}</span>
        <ul class="result"  >
  ...
  <div class="col s4 m2">
    <div class="card blue-grey darken-1">
     <div class="card-content white-text">
      <span class="card-title"> Date: ${date4}</span>
      <ul class="result"  >
